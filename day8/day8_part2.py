...
def steps2map(steps):
  ...
  for step in steps:
    ...
    if source_dests[0][-1] == 'A':
       start_nodes.append(source_dests[0])
  return [steps_map, start_nodes]

steps_map, start_nodes = steps2map(steps)
# print(steps_map)
...
for start_node in start_nodes:
  print(f"handling: {start_node}")
  step_cnt = 0
  cur_step = start_node
  cur_dir_index = ds[0]
  while True:
    step_cnt += 1
    if steps_map[cur_step][ds[cur_dir_index]][-1] == 'Z':
      break
    cur_step = steps_map[cur_step][ds[cur_dir_index]]
    cur_dir_index = (cur_dir_index + 1) % len(ds)
  steps_cnt.append(step_cnt)
print(steps_cnt)
  
import math

numbers = [18727, 24253, 18113, 22411, 21797, 16271]
...
print(find_lcm_of_list(numbers))
